...
private:
	...
	{
		return (elve_1.section_start >= elve_2.section_start && elve_1.section_start <= elve_2.section_end)
			   || (elve_1.section_end >= elve_2.section_start && elve_1.section_end <= elve_2.section_end);
	}
